        ...
        <section id="inner-headline">
            <div class="container">
                ...
                <div class="span4">
                    ...
                    <h2>Single Post  {{ this.$route.params.blogpostid }}</h2>
                    </div>
                </div>
                <div class="span8">
                    <ul class="breadcrumb">
                    ...
                    <li class="active">Blog Post Single Post</li>
                    </ul>
                </div>
                </div>
            </div>
                    ...
                    <article>
                        <div class="row">
                            ...
                            <div class="post-image">
                                ...
                                <h3><a href="#">{{getDetailBlogPost.title}}</a></h3>
                                </div>
                                <img :src="`uploads/${getDetailBlogPost.photo}`" alt="">
                            </div>
                            <p>{{getDetailBlogPost.description}}
                            <!-- <blockquote>
                            ...
                            <div class="bottom-article">
                                <ul class="meta-post">
                                <li><i class="icon-calendar"></i><a href="#">{{ getDetailBlogPost.created_at | timeformat}}</a></li>
                                <li v-if="getDetailBlogPost.user"><i class="icon-user"></i><a href="#">{{getDetailBlogPost.user.name}}</a></li>
                                <li v-else><i class="icon-user"></i><a href="#">Unknown Author</a></li>
                                <li v-if="getDetailBlogPost.category"><i class="icon-folder-open"></i><a href="#">{{getDetailBlogPost.category.cat_name}}</a></li>
...
export default {
    ...
    computed: {
        getDetailBlogPost(){
         return this.$store.getters.getDetailBlogPost
      }
    },
    methods: {
        postPhoto(img){
      ...
      singlePost(){
          this.$store.dispatch("detailBlogPost", this.$route.params.blogpostid)
      }
    },
    watch: {
        $route(to, from){
